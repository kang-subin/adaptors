...
public class Score extends BaseEntity {
    ...
    @Builder
    public Score(Long id, String uuid, String mentorNickName, String mentoringSessionUuid, String categoryCode, Integer element1, Integer element2, Integer element3, Integer element4, Integer element5, String content) {
        this.id = id;
        this.uuid = uuid;
